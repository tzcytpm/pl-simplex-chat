...
The combination of display name and full name has to be unique for the listed groups. If a group uses the name or logo of SimpleX, SimpleX network or Privateline X-Chat it must be consistent with [Permitted Uses or SimpleX trademark](./TRADEMARK.md).
