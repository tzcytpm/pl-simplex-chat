# Identity layer for Privateline X-Chat
...
The identity layer we add to Privateline X-Chat has to keep the advantages of email addressing and to solve these problems as well.

## Product requirements

- the identity of the user in Privateline X-Chat must be the same as the email address they have access to - the identity server should prove it while provisioning the address.
- the email access should not be used to access PrivatelineX address once it's provisioned.
...
- The user should be able to decide whether they want to receive connection requests from users without verified PrivatelineX addresses (all addresses are verified).
